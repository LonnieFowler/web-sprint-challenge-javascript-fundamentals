...
//nestedFunction can access the variable internal because it forms a closure within myFunction
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(item){
      dispalyNames.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`);
    })
    return dispalyNames;
  }
